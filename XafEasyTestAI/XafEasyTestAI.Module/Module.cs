...
namespace XafEasyTestAI.Module
{
    // For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
    public sealed class XafEasyTestAIModule : ModuleBase
    {
        public XafEasyTestAIModule()
        {
            //
            // XafEasyTestAIModule
            //
            AdditionalExportedTypes.Add(typeof(XafEasyTestAI.Module.BusinessObjects.ApplicationUser));

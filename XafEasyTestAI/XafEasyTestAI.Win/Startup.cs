...
namespace XafEasyTestAI.Win
{
    public class ApplicationBuilder : IDesignTimeApplicationFactory
    {
        public static WinApplication BuildApplication(string connectionString)
        {
            ...
            builder.UseApplication<XafEasyTestAIWindowsFormsApplication>();
            builder.Modules
                .AddCharts()
                .AddCloning()
                ...
                .Add<XafEasyTestAIWinModule>();
            builder.ObjectSpaceProviders
                .AddSecuredEFCore(options =>
                {
                    options.PreFetchReferenceProperties();
                })
                    .WithDbContext<XafEasyTestAI.Module.BusinessObjects.XafEasyTestAIEFCoreDbContext>((application, options) =>
                    {
